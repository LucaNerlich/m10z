...
import type {FeedKind, SitemapSection, StrapiContentType} from '@/src/lib/shared/contracts/strapi-contract/tags';
...
export {
    ...
    authorCategoryListPageTag as contentAuthorCategoryListPageTag,
    authorCategoryListTag as contentAuthorCategoryListTag,
    authorListPageTag as contentAuthorListPageTag,
    authorListTag as contentAuthorListTag,
} from '@/src/lib/shared/contracts/strapi-contract/tags';

export type {FeedKind, SitemapSection, StrapiContentType} from '@/src/lib/shared/contracts/strapi-contract/tags';
