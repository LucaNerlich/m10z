        ...
        <Layout title='Datenschutz' description='m10z Privacy'>
            <div
                ...
                <p>
                    ...
                    Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.<br />
                    <br />
                ...
                <p>
                    ...
                    zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung entnehmen.<br />
                    <br />
                    Wie erfassen wir Ihre Daten?<br />
                    Ihre Daten werden fast ausschließlich erhoben, indem Sie uns diese mitteilen (z. B. im Rahmen einer Anfrage per E-Mail). Eine
                ...
                <p>
                    ...
                    Die Daten werden erhoben, um die fehlerfreie Bereitstellung und die Sicherheit der Website zu gewährleisten. Außerdem werden die
                    Daten ggf. im Rahmen der Verwaltung und Beantwortung von Anfragen verwendet. Eine personen- bzw. nutzerbezogene Analyse des
                    Nutzerverhaltens findet nicht statt.<br />
                    <br />
                    ...
                    Daten zu erhalten. Sie haben außerdem das Recht, die Berichtigung oder Löschung dieser Daten zu verlangen. Wenn Sie eine
                ...
                <p>
                    Diese Website wird extern gehostet. Etwaige personenbezogene Daten, die auf dieser Website erfasst werden, werden auf den Servern
                    ...
                    Vertragsdaten, Kontaktdaten, Namen, Websitezugriffe und sonstige Daten, die über eine Website generiert werden, handeln.<br />
                    <br />
                    Das externe Hosting erfolgt im Interesse einer sicheren, schnellen und effizienten Bereitstellung unseres Online-Angebots durch
                    professionelle Anbieter (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die
                    Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO.<br />
                    <br />
                    Unsere Hoster werden Ihre Daten nur insoweit verarbeiten, wie dies zur Erfüllung ihrer Leistungspflichten erforderlich ist und
                ...
                <p>
                    ...
                    verarbeiten oder die Verarbeitung im Rahmen der Inanspruchnahme von Diensten Dritter oder der Offenlegung bzw. Übermittlung von
                    Daten an andere Personen, Stellen oder Unternehmen stattfindet, erfolgt dies nur im Einklang mit den gesetzlichen Vorgaben
                </p>
                ...
                <p>
                    ...
                    den gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.<br />
                    <br />
                ...
                <p>
                    ...
                    Daten so lange bei uns, bis deren die Verarbeitung erlaubenden Einwilligungen widerrufen werden oder sonstige Erlaubnisse
                    ...
                    <br />
                    Wenn Sie ein berechtigtes Löschersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten
                    gelöscht, sofern wir keine anderen rechtlich zulässigen Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B.
                    gesetzliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.
                </p>
                ...
                <p>
                    ...
                    1 lit. a DSGVO. Im Falle einer ausdrücklichen Einwilligung in die Übertragung personenbezogener Daten in Drittstaaten erfolgt die
                    Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Soweit Ihre personenbezogenen Daten zur Bearbeitung
                    etwaiger Anfragen Ihrerseits erforderlich sind, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des
                ...
                <p>
                    ...
                    Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit einer bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf
                    unberührt.<br />
                    <br />
                    ...
                    EINZULEGEN. DIE JEWEILIGE RECHTSGRUNDLAGE, AUF DENEN EINE VERARBEITUNG BERUHT, ENTNEHMEN SIE DIESER DATENSCHUTZERKLÄRUNG. WENN SIE
                    WIDERSPRUCH EINLEGEN, WERDEN WIR IHRE BETROFFENEN PERSONENBEZOGENEN DATEN NICHT MEHR VERARBEITEN, ES SEI DENN, WIR KÖNNEN
                ...
                <p>
                    ...
                    <br />
                    Wenn Sie per E-Mail mit uns kommunizieren, werden die Adressen der Empfänger sowie Absender als auch weitere Informationen
                    betreffend den E-Mailversand (z.B. die beteiligten Provider) sowie die Inhalte der jeweiligen E-Mails verarbeitet. Die
                    vorgenannten Daten können ferner zu Zwecken der Erkennung von SPAM verarbeitet werden. Wir bitten darum, zu beachten, dass E-Mails
                    im Internet grundsätzlich nicht verschlüsselt versendet werden. Im Regelfall werden E-Mails zwar auf dem Transportweg
                    verschlüsselt, aber (sofern kein sogenanntes Ende-zu-Ende-Verschlüsselungsverfahren eingesetzt wird) nicht auf den Servern, von
                    denen sie abgesendet und empfangen werden. Wir können daher für den Übertragungsweg der E-Mails zwischen dem Absender und dem
                    Empfang auf unserem Server keine Verantwortung übernehmen.<br />
                    <br />
                ...
                <p>
                    ...
                    des Ausmaßes der Bedrohung der Rechte und Freiheiten natürlicher Personen geeignete technische und organisatorische Maßnahmen, um
                    ein dem Risiko angemessenes Schutzniveau zu gewährleisten.<br />
                    <br />
                    ...
                    des Zugangs zu den Daten als auch des sie betreffenden Zugriffs, der Eingabe, der Weitergabe, der Sicherung der Verfügbarkeit und
                    ihrer Trennung. Ferner berücksichtigen wir den Schutz personenbezogener Daten bereits bei der Entwicklung bzw. Auswahl von
                ...
                <p>
                    ...
                    <br />
                    Sofern wir in dieser Datenschutzerklärung Adressen und Kontaktinformationen von Unternehmen und Organisationen angeben, bitten wir
