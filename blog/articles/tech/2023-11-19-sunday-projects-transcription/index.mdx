...
## Das Problem
Ich bin ein Datenmessie.
Ich verbringe einen beachtlichen Anteil meiner Zeit darin für meine Arbeit Informationen zu suchen, zu organisieren, verteilen und entsprechend viel lese ich.
Es macht so einen beachtlichen Anteil aus, dass ich mir beim Schreiben dieser paar Zeilen gefragt habe wieso ich nicht eine Karriere als Bibliothekar angestrebt habe.
Das geht so weit, dass ich letztens von einem ehemaligen Kollegen angeschrieben wurde um wiederum seinen Kollegen bei Wien Energie für ein Projekt einen Crashkurs zu einem spezifischen Thema gegeben habe (inkl. Folder mit Quellen).
