...
<Image
  style={{ width: '100%' }}
  img={require('/static/img/articles/fb16.png')}
  alt="Fundbüro #16: Motorhead und Hard Truck: Apocalypse – Episodenbild"
/>
...
Schaut euch unbedingt auch das Video zur Folge an, in das Edgar wieder viel Schweiß, Blut und Tränen investiert hat.
 <a href="https://youtu.be/BZudYGEettU" target="_blank" rel="noopener noreferrer" aria-label="YouTube-Video zur Folge Fundbüro #16 öffnen (neuer Tab)"><Image style={{ width: '100%' }} img={require('@site/static/img/articles/fb16_yt.png')} alt="Vorschaubild: Das Video zur Folge Fundbüro #16 auf YouTube"/></a>
...
[Das Video zum Podcast](https://youtu.be/BZudYGEettU)
