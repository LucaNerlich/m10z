        ...
        <Layout title='Hello' description='Wer wir sind'>
            <div className={styles.wrapper}>
                ...
                <div className={styles.highlightBox}>
                    <p><strong>M10Z ist ein offener Kanal für Videospielcontent und das Drumherum.</strong></p>
                    <p>
                    ...
                    <p>
                        <em>Alles aus Spaß am Medium und dem kreativen Prozess.<br />
                        Unentgeltlich, unabhängig, ungezwungen.</em>
                    </p>
                </div>
                ...
                <div className={styles.twoColumnSection}>
                    ...
                    <div>
                        ...
                        <div className={styles.textSection}>
                            ...
                            <p>
                                Jedes Format hat seinen eigenen Charakter und wird von verschiedenen Autor:innen betreut.
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.compactCard}>
                        <p>
                            <strong>Wer darf mitmachen?</strong> Jede*r mit Lust an Themen die zu M10Z passen.
                            Du musst keine Erfahrung haben – dies darf gerne ein Versuch für Dich sein.
                        </p>
                        <p>
                ...
                <div className={styles.warningBox}>
                    <p>
                        <strong>M10Z hat keinen Platz für:</strong> Sexismus, Rassismus, Antisemitismus, Homo- und Transphobie, Klassismus, Ableismus.
                    </p>
                </div>
